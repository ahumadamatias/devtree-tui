...
pub(super) fn keybind_help_groups(app: &AppState) -> Vec<HelpGroup> {
    ...
    let workspace_tab = vec![
        ...
        help_entry(keybind_label(&kb.clone_repository), "clone repository"),
        ...
        help_entry(
            keybind_label(&kb.toggle_worktree_group),
            "collapse/expand worktree group",
        ),
    ...
    let panes = vec![
        ...
        help_entry(keybind_label(&kb.clear_pane_name), "clear pane name"),
